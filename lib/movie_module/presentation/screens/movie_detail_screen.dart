  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => sl<MovieDetailsBloc>()
        ...
        ..add(GetRecommendedMovieEvent(id)),
      lazy: false,
                  ...
                  child: FadeInUp(
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(state.movieDetails!.original_title,
                            ...
                            children: [
                              ...
                              Row(
                                children: [
                                  ...
                                  Text(
                                    (state.movieDetails!.vote_average / 2)
                                        .toStringAsFixed(1),
                                    style: const TextStyle(
                                      fontSize: 16.0,
                                      fontWeight: FontWeight.w500,
    ...
    return BlocBuilder<MovieDetailsBloc, MovieDetailsState>(
      builder: (context, state) => SliverGrid(
        delegate: SliverChildBuilderDelegate(
              (context, index) {
            final recommendation = state.recommendedMovie[index];
            return FadeInUp(
              from: 20,
              duration: const Duration(milliseconds: 500),
              child: ClipRRect(
                ...
                child: CachedNetworkImage(
                  imageUrl: ApiConstance.imageUrl(recommendation.poster_path!),
          ...
          childCount: state.recommendedMovie.length,
        ),
